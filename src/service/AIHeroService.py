...
class AIHeroService:
    ...
    def generate_compositions(self, harmony_specs, evolutionary_specs=None, melody_id=""):
    ...
    def generate_compositions_with_train_data(self, melody_specs_list, melody_id=""):
        ai_hero_data = AIHeroData()
        melody_tuples = []
        try:
            for melody_specs in melody_specs_list:
