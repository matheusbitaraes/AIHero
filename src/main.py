...
from model.ApiModels import MelodyRequestResponse, MelodyRequestInput, ApiConfig, MelodySpecs
...
def create_app():
    ...
    def getMelodies(melody_specs: MelodySpecs = DEFAULT_MELODY_REQUEST, source: str = "evo"):
