...
class Fitness:
    ...
    def notes_on_same_chord_key(self, note_sequence, chord_notes):
        number_notes_in_chord = 0
        a, b = note_sequence[note_sequence != -1]
    ...
    def intervals_evaluation(self, note_sequence):
    ...
    def notes_on_tempo(self, note_sequence):
        notes = note_sequence[note_sequence != -1]
        n = 0
        for i in range(0, len(note_sequence)):
            if i % 4 == 0:
