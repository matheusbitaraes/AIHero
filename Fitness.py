class Fitness:
    def __init__(self, w1=50, w2=50, w3=100, w4=-25, w5=12, w6=50, w7=25):
        self.w1 = w1
        self.w2 = w2
        self.w3 = w3
        self.w4 = w4
    ...
    def eval(self, note_sequence, chord_notes):
        ...
        f5 = 100 * self.evalPitch(note_sequence, self.w5)  # função para escolher solos mais graves ou agudos (0-100)
        ...
        fitness = self.w1 * f1 + self.w2 * f2 + self.w3 * f3 + self.w4 * f4 + f5 + self.w6 * f6 + self.w7 * f7
        return fitness
